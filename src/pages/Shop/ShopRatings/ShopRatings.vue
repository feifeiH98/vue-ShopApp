  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on:hasText}" @click="toggleHasText">
          ...
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend"  >
                ...
                <span class="item" v-for="(name,index) in rating.recommend" :key="index">{{name}}</span>
...
export default {
  data(){
    return {
      hasText:true,  //是否显示只有文本的
      selectType:2,  //选择满意的类型，0是满意，1是不满意，2是全部  
    }
  },
  mounted(){
  ...
  computed:{
    ...
    filterRatings(){
      // 得出相关数据
      const {ratings,hasText,selectType}=this;
      // 产生一个过滤的新数组
      return ratings.filter(rating=>{
        const {rateType,text}=rating;
        // 分析条件
        // 条件一：selectType和rateType，selectType===2||selectType===rateType
        // 条件二：hasText:true/false 和 text:有值/无值，！hasText||text.lenght>0
        return (selectType===2||selectType===rateType) && (!hasText||text.length>0)
      })
    }
  },
  methods:{
